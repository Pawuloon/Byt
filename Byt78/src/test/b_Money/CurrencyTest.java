...
public class CurrencyTest {
	...
	public void testGetRate()
	{
		...
		assertEquals(Optional.of(2d), Optional.of(NOK.getRate()));
	}

	// Test that the rate is set correctly
	@Test
	...
	// Test that the universal value of money is calculated correctly
	@Test
	...
	// Test that the value with currency is calculated correctly
	@Test
