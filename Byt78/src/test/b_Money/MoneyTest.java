...
// Class money tests for the methods of the class Money
public class MoneyTest {
	...
	// Test that the rate is returned correctly
	@Test
	...
	// Test that the naming is returned correctly
	@Test
	...
	// Test that the universal value is calculated correctly
	@Test
	...
	// Test that the value of money is calculated correctly
	@Test
	...
	// Test that the value of money after addition is calculated correctly
	@Test
	public void testAdd()
	{
		...
		assertEquals(Optional.of(NOK100.add(EUR10).getAmount()), Optional.of(20000d));
	}

	// Test that the value of money after subtraction is calculated correctly
	@Test
	public void testSub()
	{
		...
		assertEquals(Optional.of(NOK100.sub(EUR10).getAmount()), Optional.of(0d));
	}

	// Test that the value of money is zero or not zero
	@Test
	...
	// Test that the value of money is negative or non-negative
	@Test
	...
	// Test that the value of money is compared correctly
	@Test
