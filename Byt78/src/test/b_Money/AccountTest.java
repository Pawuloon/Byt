...
public class AccountTest {
	...
	// Test for adding and removing a TimedPayment
	@Test
	public void testAddRemoveTimedPayment()
	{
		testAccount.addTimedPayment("1", 2, 2, new Money(1000000, SEK), Nordea, "Bob");
		assertTrue(testAccount.timedPaymentExists("1"));
		testAccount.addTimedPayment("2", 2, 2, new Money(1000000, SEK), DanskeBank, "Gertrud");
		assertTrue(testAccount.timedPaymentExists("2"));
		testAccount.addTimedPayment("3", 2, 2, new Money(1000000, SEK), SweBank, "Alice");
	...
	// Test for retrieving a TimedPayment
	@Test
	public void testTimedPayment()
	{
		testAccount.addTimedPayment("1", 2, 2, new Money(300, SEK), Nordea, "Bob");
		testAccount.addTimedPayment("2", 2, 2, new Money(1000000, SEK), DanskeBank, "Gertrud");
		testAccount.addTimedPayment("3", 2, 2, new Money(1000000, SEK), SweBank, "Alice");
	...
	// Test for adding a TimedPayment
	@Test
	...
	// Test for getting balance from an account
	@Test
