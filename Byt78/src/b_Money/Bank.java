...
public class Bank {
	 ...
	 */
	// Instead of get used put which should have been there in first place in case of opening a new account
	 ...
	 * @throws AccountDoesNotExistException If the account does not exist
	 */
	// TODO check if it should be like that
